                ...
                <div class="d-lg-none position-absolute start-50 top-50 translate-middle">
                    <div class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-menu-center mt-2 shadow-sm border-0" style="left: 50%; transform: translateX(-50%);">
                            ...
                            <li><a class="dropdown-item" href="{{ route('profil') }}"><i class="bi bi-person me-2"></i> Profil Saya</a></li>
                            <li><a class="dropdown-item" href="{{ route('profil.activity') }}"><i class="bi bi-list-check me-2"></i> Aktifitas Saya</a></li>
                            <li><a class="dropdown-item" href="{{ route('profil.settings') }}"><i class="bi bi-gear me-2"></i> Pengaturan</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6 col-md-12 mb-4 mb-lg-0">
                    <img src="{{ asset('assets/img/logo.png') }}" alt="PastiFIX Logo" class="mb-3" style="height: 120px;">
