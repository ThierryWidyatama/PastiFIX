...
<head>
    <meta charset="UTF-8">
    <title>Verifikasi Akun PastiFIX</title>
</head>
                    ...
                    <tr>
                        <td style="padding:30px 32px;">
                            ...
                            <p style="margin:0 0 18px 0; font-size:14px; line-height:1.6;">
                                Terima kasih telah mendaftar di <strong>PastiFIX</strong>.
                                Untuk menyelesaikan proses verifikasi akun, silakan gunakan kode verifikasi berikut:
                            </p>
                            ...
                            <p style="margin:16px 0 0 0; font-size:13px; color:#777; text-align:center;">
                                Jika Anda tidak merasa melakukan pendaftaran akun,
